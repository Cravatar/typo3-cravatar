...
namespace MiniFranske\Cravatar\Controller;
...
class ProxyController
{
    ...
    public function proxyAction(Request $request): Response
    {
        ...
        if (!isset($params['md5'], $params['size'], $params['d'])) {
            throw new \Exception('Missing cravatar parameters', 1470912686);
        }
        ...
        $client = new Client(['base_uri' => 'https://www.cravatar.cn']);
